try:
    ...
    print("You need to download pymysql to run this program.")
all_items = []
...
def mainMenu():
    ...
    c = Cart()
    choiceIsValid = False #added as a flag to catch errors
    while choiceIsValid == False:#ensures a valid option gets picked
        try:
...
def loadDataToItemClass():
    try:
        ...
        print("Are you sure you're trying to connect to the correct database?")
